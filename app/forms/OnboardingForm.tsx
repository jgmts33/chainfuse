...
import { CheckBoxFormField } from "./fields/CheckBoxFormField.js";
import { CreateAccountFormField } from "./fields/CreateAccountFormField.js";
import { NftUploadFormField } from "./fields/NftUploadFormField.js";
import { SelectFormField } from "./fields/SelectFormField.js";
import { TextFormField } from "./fields/TextFormField.js";
import { UploadFormField } from "./fields/UploadFormField.js";
...
export default function OnboardingForm(props: OnboardFormProps) {
        ...
        <Grid container spacing={2}>
          ...
          >
            <DecentralizedProfile
              ...
              acceptPayments={input.acceptPayments}
              address={""}
              work={input.work}
              linkedIn={input.linkedIn}
              discoverable={input.discoverable}
              avatar={input.avatar}
              kyc={Boolean(input.kyc)}
            ...
            >
              <React.Fragment>
                <Typography component="span" variant="h6" sx={{ mb: 1 }}>
                  Step {activeStep + 1} - {formTemplate.steps[activeStep].title}
                </Typography>
              </React.Fragment>
