...
import { TemplateKey } from "core/templates";
...
export function createValidator<T extends "create" | "update">(
  ...
  template.fields.forEach((field: templates.TemplateField) => {
    if (
